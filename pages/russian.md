...
<br />
Как мы уже знаем, для латинской буквы E потребуется всего один байт, т.к. она находится в первом диапазоне. 
...
<br />
Таким образом, мы определили, что для символа “галочка” первый байт будет равен 1110хххх. Второй и третий байты будут начинаться с 10хххххх.
...
В итоге, получим двоичное представление для символа “галочка”. Это 3 байта:
```
11100010 10011100 10010011
```
Теперь мы знаем способ представления кодовых точек в кодировке UTF-8. Ниже рассмотрим работу с кодировкой UTF-16.
